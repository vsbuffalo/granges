...
fn granges_binary_path() -> PathBuf {
...
fn test_against_bedtools_slop() {
    ...
    granges_random_bed("tests_data/hg38_seqlens.tsv", 100_000, 
                       Some(&random_bedfile_path), true)
    ...
    assert_eq!(String::from_utf8_lossy(&bedtools_output.stdout), 
